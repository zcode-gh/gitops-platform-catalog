...
# Terragrunt is a thin wrapper for Terraform/OpenTofu that provides extra
# tools for working with multiple modules, remote state and
# locking: https://github.com/gruntwork-io/terragrunt
# --------------------------------------------------------------------------
